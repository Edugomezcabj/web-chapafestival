  ...
  return (
    ...
    >
      ...
      <h1 className="relative z-10 flex flex-col items-center justify-center gap-2 sm:gap-3 mb-10 sm:mb-12">
        <span className="bg-[#d94814] text-white font-display text-4xl sm:text-6xl md:text-7xl lg:text-8xl uppercase px-[6px] py-1 sm:px-[10px] sm:py-2 tracking-tight shadow-2xl block">
          CHAPAFESTIVAL 2026
        </span>
        <span className="bg-[#e8dec8] text-[#d94814] font-display text-4xl sm:text-6xl md:text-7xl lg:text-8xl uppercase px-[6px] py-1 sm:px-[10px] sm:py-2 tracking-tight shadow-2xl block">
          YA TIENE FECHA
        </span>
      </h1>
