export default function SpotifyPlaylist() {
    return (
        <section
            className="w-full bg-zinc-950 py-24 px-4 sm:px-6 relative overflow-hidden bg-fixed bg-center bg-cover"
        ...
        >
            ...
            <div className="max-w-5xl mx-auto flex flex-col items-center relative z-10">
                ...
                {/* Contenedor del reproductor de Spotify con tu link oficial */}
